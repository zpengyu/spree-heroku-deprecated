...
This is an update of http://github.com/RSpace/spree-heroku that works with Rails >= 3.0.6 and Spree >= 0.50.0
...
This extension has been tested with Spree 0.50.0 and Rails 3.0.6. If you have problems using the extension with a newer version of Spree, it could be due to Spree's gem dependencies having changed.
